...
- **Design Theme**: Clean professional aesthetic inspired by zergai.com — minimal effects, bracketed section labels, generous spacing. Three-tone color scheme: sky blue (#8eb5cc), warm off-white (#f0ece4), dark ink (#1e2830) in alternating sections. Neon green (#39ff14) accent, purple (#8b5cf6) secondary. Y2K golden yellow (#e8c820) keycap buttons. Fonts: Space Grotesk (headings), Space Mono (body), Instrument Serif (accents). Y2K aesthetic with crosshair cursor. All styling defined inline in `client/index.html`
